...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11119 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t11119 = (function (val,box,meta11120){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11119.cljs$lang$type = true;
cljs.core.async.impl.channels.t11119.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11119";
cljs.core.async.impl.channels.t11119.cljs$lang$ctorPrWriter = (function (this__4118__auto__,writer__4119__auto__,opt__4120__auto__){return cljs.core._write.call(null,writer__4119__auto__,"cljs.core.async.impl.channels/t11119");
});
cljs.core.async.impl.channels.t11119.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t11119.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11121){var self__ = this;
var _11121__$1 = this;return self__.meta11120;
});
cljs.core.async.impl.channels.t11119.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11121,meta11120__$1){var self__ = this;
var _11121__$1 = this;return (new cljs.core.async.impl.channels.t11119(self__.val,self__.box,meta11120__$1));
});
cljs.core.async.impl.channels.__GT_t11119 = (function __GT_t11119(val__$1,box__$1,meta11120){return (new cljs.core.async.impl.channels.t11119(val__$1,box__$1,meta11120));
});
}
return (new cljs.core.async.impl.channels.t11119(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_11122 = self__.takes.pop();if((taker_11122 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11122))
{var take_cb_11123 = cljs.core.async.impl.protocols.commit.call(null,taker_11122);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11123,taker_11122,this$__$1){
return (function (){return take_cb_11123.call(null,null);
});})(take_cb_11123,taker_11122,this$__$1))
);
} else
{}
{

...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11113 = (0);while(true){
var m_11114 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11114 == null))
{} else
{m_11114.call(null);
if((count_11113 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11115 = (count_11113 + (1));
count_11113 = G__11115;
continue;
}
} else
{}
